...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
	...
	register_options([
		...
		OptString.new('ETERNALSYNERGYPATH',[true,'Path directory of EternalSynergy','/root/EternalSynergy-Doublepulsar-Metasploit/deps/']),
		OptString.new('DOUBLEPULSARPATH',[true,'Path directory of Doublepulsar','/root/EternalSynergy-Doublepulsar-Metasploit/deps/']),
